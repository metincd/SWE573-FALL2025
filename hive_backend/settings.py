...
SECRET_KEY = "django-insecure--e1i-zdgljw6&0b5mugkc(o%@t*7=9v!6bro$-=h4ip!$(od9b"
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DB_NAME", "hive_db"),
        "USER": os.getenv("DB_USER", "hive_user"),
        "PASSWORD": os.getenv("DB_PASSWORD", "hive_password"),
